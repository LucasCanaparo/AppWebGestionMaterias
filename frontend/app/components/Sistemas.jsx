...
export default function Sistemas() {
    ...
    useEffect(() => {
        const Materias = async () => {
            const materias = await axios.get('https://mi-backend.onrender.com/materiasSistemas')
            //ordena por anio
    ...
    const handleAprobado = async (data) => {
        ...
        try {
            ...
            const aprobada = await axios.put(`https://mi-backend.onrender.com/materiasSistemas/${materiaActualizada.id}`, materiaActualizada)
            if (aprobada) {
    ...
    const handleDesaprobado = async (data) => {
        ...
        try {
            ...
            const desaprobada = await axios.put(`https://mi-backend.onrender.com/materiasSistemas/${materiaActualizada.id}`, materiaActualizada)
            if (desaprobada) {
    ...
    return (
        <div style={{
            ...
            <h1 style={{ color: 'white' }}>Malla Ingenieria en Sistemas</h1>
            <div className="d-flex justify-content-center gap-4">
                <a href="https://www.institucional.frc.utn.edu.ar/sistemas/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="link-custom">
                    <h5>Departamento de Ing. en Sistemas</h5>
                </a>
